            ...
            <div className="lg:col-span-2 space-y-8 reveal">
              ...
              <div className="glass-card p-7 rounded-2xl">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { label: "Instagram", href: SOCIALS.instagram, Icon: InstagramIcon, color: "hover:text-pink-400" },
                    { label: "YouTube", href: SOCIALS.youtube, Icon: YouTubeIcon, color: "hover:text-red-400" },
                    { label: "TikTok", href: SOCIALS.tiktok, Icon: TikTokIcon, color: "hover:text-white" },
                    { label: "LinkedIn", href: SOCIALS.linkedin, Icon: LinkedInIcon, color: "hover:text-blue-400" },
