...
const CONTENT: Record<string, Array<{ title: string; thumb: string; views: string; date: string; link: string }>> = {
  ...
  tiktok: [
    ...
    { title: "Free tools that replace ₦50K/month subscriptions", thumb: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&h=700&fit=crop", views: "6.3K views", date: "3 weeks ago", link: SOCIALS.tiktok },
  ],
  instagram: [
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="absolute inset-0 z-0">
              <img
                src="https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=1200&h=400&fit=crop"
                alt="Featured video"
            ...
            <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center md:items-start gap-6">
              <div className="w-16 h-16 rounded-full bg-blue-500/90 flex items-center justify-center flex-shrink-0 glow-blue group-hover:scale-110 transition-transform duration-300">
                <Play size={26} fill="white" className="text-white ml-1" />
              </div>
              <div>
                <span className="text-blue-400 text-xs uppercase tracking-widest font-medium mb-2 block">Featured Video</span>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-2 mb-10 overflow-x-auto pb-2 reveal">
            {TABS.map(({ id, label, Icon, color }) => (
              ...
              >
                <span className={activeTab === id ? color : "text-current"}>
                  <Icon />
                </span>
                {label}
              </button>
              ...
              >
                <div className={`relative overflow-hidden ${isVertical ? "h-56 md:h-72" : "h-44"}`}>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="w-12 h-12 rounded-full bg-blue-500/90 flex items-center justify-center glow-blue">
                      <Play size={18} fill="white" className="text-white ml-0.5" />
                    </div>
                  </div>
                  <div className="absolute top-3 right-3">
                    <ExternalLink size={14} className="text-white/50 group-hover:text-blue-300 transition-colors" />
                  </div>
                </div>
                <div className="p-4">
          ...
          <div className="mt-10 text-center reveal">
            <a
              href={SOCIALS[activeTab as keyof typeof SOCIALS] || SOCIALS.youtube}
              target="_blank"
              rel="noopener noreferrer"
              className="btn-glass py-3 px-8 inline-flex"
            >
