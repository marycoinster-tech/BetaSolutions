        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              {[
                { href: SOCIALS.instagram, Icon: InstagramIcon, label: "Instagram", hoverColor: "hover:border-pink-500/30" },
                { href: SOCIALS.tiktok, Icon: TikTokIcon, label: "TikTok", hoverColor: "hover:border-white/20" },
                { href: SOCIALS.facebook, Icon: FacebookIcon, label: "Facebook", hoverColor: "hover:border-blue-600/30" },
                { href: SOCIALS.youtube, Icon: YouTubeIcon, label: "YouTube", hoverColor: "hover:border-red-500/30" },
                { href: SOCIALS.linkedin, Icon: LinkedInIcon, label: "LinkedIn", hoverColor: "hover:border-blue-400/30" },
                ...
                <a
                  ...
                  aria-label={label}
                  className={`w-9 h-9 rounded-xl glass-card flex items-center justify-center text-white/60 hover:text-white ${hoverColor} transition-all duration-300 border border-white/5`}
                >
                  <Icon />
                </a>
              ))}
